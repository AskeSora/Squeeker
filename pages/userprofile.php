...
if (isset($_GET['id'])) {
    ...
    $postlist = $postsobject->getProfilePosts($id);
    $user = $usersobject->getUserByID($id);
    if ($user) {
    ...
    <div class="content">
        <div class="profilestuff">
            ...
            <?php else: ?>
                <p>No bio</p>
            <?php endif; ?>
            <?php if ($usersobject->isFollowing($UserID, $id)): ?>
                <form action="code/Unfollowuser.php" method="POST">
                    <input type="hidden" name="Followed_user_id" value="<?php echo $id; ?>">
                    <button type="submit" name="unfollow" class="followbtn">Unfollow</button>
                </form>
            <?php else: ?>
                <form action="code/Followuser.php" method="POST">
                    <input type="hidden" name="Followed_user_id" value="<?php echo $id; ?>">
                    <button type="submit" name="follow" class="followbtn">Follow</button>
                </form>
            <?php endif; ?> 
        </div>
